...
public class EQueen extends JFrame{
        ...
        JFrame frame = new JFrame("ĐIỀU KHIỂN");
...
//				bt[i][j].setFont(new Font("Britannic Bold", 1, 25));
		...
		tf.setForeground(Color.white);
                ...
                JButton pauseButton = new JButton("Dừng lại");
                JButton coutinueButton = new JButton("Tiếp tục");
                exitButton.addActionListener((ActionEvent e) -> {
                    System.exit(0); // Thoát khỏi ứng dụng
                });
                pauseButton.addActionListener((ActionEvent e) -> {
                    timer.stop(); // Thoát khỏi ứng dụng
                });
                coutinueButton.addActionListener((ActionEvent e) -> {
                    timer.start(); // Thoát khỏi ứng dụng
                });

            // Thêm nút thoát vào giao diện
                frame.getContentPane().add(exitButton,"South");
                frame.getContentPane().add(pauseButton,"Center");
                frame.getContentPane().add(coutinueButton,"North");
                exitButton.setPreferredSize(new Dimension(50, 50));
                pauseButton.setPreferredSize(new Dimension(50, 50));
                coutinueButton.setPreferredSize(new Dimension(50, 50));
                frame.pack();
